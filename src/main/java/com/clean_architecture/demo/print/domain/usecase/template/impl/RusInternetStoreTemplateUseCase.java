...
/**
 * Шаблон печати договора интернет-магазина РФ.
 * Является шаблоном печати по умолчанию, если никакие другие шаблоны печати не были найдены.
 */
@Component
@Primary
@Order(0)
public class RusInternetStoreTemplateUseCase implements TemplateUseCase {

    private static final Set<Class<? extends TagUseCase>> TAGS = Set.of(
            ContractNumber.class, ClientName.class, IsClientPaysVat.class, IsSelfEmployed.class,
    ...
    public TemplateType getType() {
        return TemplateType.RUS_INTERNET_STORE;
    }
