...
/**
 * Шаблон печати договора курьерских услуг Казахстана.
 */
@Component
@Primary
@Order(4)
public class KzCourierTemplateUseCase implements TemplateUseCase {
    ...
    private static boolean isRussianLegalEntity(@Nonnull Contract contract) {
        ...
        return Country.KAZAKHSTAN.getIso().equals(legalEntityCountry);
    }
    ...
    private boolean isRussianClient(@Nonnull Contract contract) {
        ...
        return Country.KAZAKHSTAN.getIso().equals(clientCountry);
    }
}
